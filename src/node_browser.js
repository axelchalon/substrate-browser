...
function init(module) {
    if (typeof module === 'undefined') {
        throw new Error('Please specify an argument -- modified for bundling in CRA.')
    ...
    imports.wbg.__wbg_globalThis_8df2c73db5eac245 = function() {
        try {
            throw new Error('Not implemented (globalThis -- modified for bundling in CRA)');
    ...
    imports.wbg.__wbg_self_937dd9f384d2384a = function() {
        try {
            throw new Error('Not implemented (self -- modified for bundling in CRA)');
            // const ret = self.self;
            // return addHeapObject(ret);
        } catch (e) {
            handleError(e)
